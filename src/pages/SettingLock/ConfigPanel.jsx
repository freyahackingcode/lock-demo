// Config 抽屉面板：让用户手动切换 model / platform / isOwner / 电量 / spec 存在性
...
export default function ConfigPanel({ open, onClose }) {
  ...
  return (
    <div className="sl-cfg-mask" onClick={onClose}>
      <div className="sl-cfg-panel" onClick={(e) => e.stopPropagation()}>
        <div className="sl-cfg-header">
          <div className="sl-cfg-title">配置面板 · 复原生产实际</div>
          <button className="sl-cfg-close" onClick={onClose} aria-label="关闭">×</button>
        </div>

        <div className="sl-cfg-scroll">
          <div className="sl-cfg-hint">
            切换 model / spec / 平台 / 权限，主界面按 <code>miot.lock.spec</code> 的判定逻辑实时重渲染
          </div>
          ...
          <div className="sl-cfg-group">
            ...
            <div className="sl-cfg-hint" style={{ marginTop: 8 }}>
              {preset.label}
            </div>
          ...
          <div className="sl-cfg-group">
            ...
            <div className="sl-cfg-row">
              <span>工作模式（doorLockCamera.mode）</span>
            ...
            <div className="sl-cfg-row">
              ...
              <span className="sl-cfg-hint" style={{ margin: 0 }}>
                {isUwbDisabledByMode(s) ? '是（省电模式 / low2）' : '否'}
              </span>
            </div>
          ...
          <div className="sl-cfg-group">
            ...
            <label className="sl-cfg-check">
              ...
              />
              <span>anti-lock-unlock-permission（反锁"不受反锁限制的人"入口）</span>
            </label>
            <label className="sl-cfg-check">
              <input
                type="checkbox"
